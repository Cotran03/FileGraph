...
- `gui/settings_dialog.py`: 그래프 표시, 노드 색상, 강조색, 확장자 아이콘 매핑, 무시 폴더 설정 화면
...
- 별도 설정 화면, 노드 타입별/hover 라벨 표시 방식 설정, 간선 라벨 표시 방식 설정, 색상/강조/아이콘/무시 폴더 UI
...
- 설정 화면 주요 동작: 무시 폴더 목록, 그래프 라벨 기본값, 노드 색상, 강조 색상, 확장자 아이콘 매핑
